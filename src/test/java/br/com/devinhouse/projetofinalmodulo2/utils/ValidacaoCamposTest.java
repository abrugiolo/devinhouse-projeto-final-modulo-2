...
//    @Test
//    public void deveRetornarTrueAoValidarInteressadoNulo() {
//
//        Interessado interessado = null;
//
//        assertTrue(validacaoCampos.validadorInteressadoInativo(interessadoRepository, interessado));
//    }
//
//    @Test
//    public void deveRetornarTrueAoValidarInteressadoInativo() {
//
...
//
//    @Test
//    public void deveRetornarFalseAoValidarInteressadoAtivo() {
//
//        Interessado interessado = new Interessado();
//        interessado.setFlAtivo('s');
//
//        assertFalse(validacaoCampos.validadorInteressadoInativo(interessadoRepository, interessado));
//    }
//
//    @Test
//    public void deveRetornarTrueAoValidarAssuntoNulo() {
//
//        Assunto assunto = null;
//
//        assertTrue(validacaoCampos.validadorAssuntoInativo(assuntoRepository, assunto));
//    }
//
//    @Test
//    public void deveRetornarTrueAoValidarAssuntoInativo() {
//
...
//
//    @Test
//    public void deveRetornarFalseAoValidarAssuntoAtivo() {
//
//        Assunto assunto = new Assunto();
//        assunto.setId(1);
//
//        Assunto assuntoBuscado = new Assunto();
//        assuntoBuscado.setFlAtivo('s');
//
//        when(assuntoRepository.findById(1)).thenReturn(Optional.of(assuntoBuscado));
//
//        boolean result = validacaoCampos.validadorAssuntoInativo(assuntoRepository, assunto);
//
//        assertFalse(result);
//    }
